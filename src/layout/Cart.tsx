...
export default function Cart() {
    ...
    return (
        <div id="Cart" className="h-screen w-screen">
            ...
            <main className="h-auto w-screen flex flex-nowrap">
                <section className="min-h-screen w-[70vw] !overflow-y-scroll ">
                ...
                <article className="w-[30vw] bg-[#e3dfda]/90 sticky bottom-0 overflow-y-hidden shadow min-[800px]:h-[90vh] min-[800px]:shadow-lg">
                    hola
                </article>
            </main>
        </div>
